...
class ComfyUI_Gemini_Native_seed:
    """
    ...
    def generate_image(self, prompt, api_key, model, mode, aspect_ratio, image_size,
                       seed=-1,image1=None, image2=None, image3=None, image4=None,
        ...
        try:
            ...
            # 构造 config 参数字典（有条件地加入 seed/temperature/candidate_count）
            config_kwargs = {
                "response_modalities": ['IMAGE', 'TEXT'],
                "image_config": image_config,
            }
            # 只有当 user 提供了合法 seed（>=0）时才设置
            if seed is not None:
                config_kwargs["seed"] = int(seed)
            # config_kwargs["seed"] = -1
...
NODE_CLASS_MAPPINGS = {
    "ComfyUI_Gemini_Native_seed": ComfyUI_Gemini_Native_seed,
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "ComfyUI_Gemini_Native_seed": "Nano Banana Pro seed (147ai.com)",
}
