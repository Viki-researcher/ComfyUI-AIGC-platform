...
- **Pre-existing lint issues**: Both frontend (13+ prettier/prettier formatting errors) and backend (6 ruff errors, including 4 F841 unused-variable warnings) have pre-existing lint issues that are not blockers.
